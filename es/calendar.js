...
class Calendar extends Component {
  ...
  render() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: cn(this.props.className, calendarClass, this.props.portal ? theme.portal : ""),
      onMouseDown: e => this.props.above(true),
      onMouseUp: e => this.props.above(false),
      style: this.props.style
    }, level != 'hours' && /*#__PURE__*/React.createElement(Navigation, {
      ...
      return /*#__PURE__*/React.createElement(Cell, {
        ...
        today: cell.today,
        moment: cell.moment,
        onClick: type !== 'header' ? this.onNavigateCell.bind(this) : noop,
        theme: theme,
        invalid: this.props.validate(cell.moment, level)
      });
    }).filter(cell => cell != null), level != 'hours' && /*#__PURE__*/React.createElement("div", {
