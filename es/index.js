...
class Kronos extends Component {
  ...
  render() {
    const mainClasses = cn("react-kronos", this.props.className, this.props.instance, this.props.theme.kronos, {
    ...
    if (this.props.portal) {
      return /*#__PURE__*/React.createElement(FloatingContainer, null, ({
        ...
        "data-toolbox": "kronos"
      }, this.renderInput(reference), /*#__PURE__*/React.createElement(FloatingPortal, null, /*#__PURE__*/React.createElement("div", {
        ref: floating,
        style: {
          position: strategy,
