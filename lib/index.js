    ...
    value: function onChangeInput(e) {
      ...
      if (datetime.isValid()) {
        ...
        if (this.props.format === 'DD/MM/YYYY') {
          var _datetime$format$spli = datetime.format('DD/MM/YYYY').split('/'),
              _datetime$format$spli2 = _slicedToArray(_datetime$format$spli, 3),
              date = _datetime$format$spli2[0],
              month = _datetime$format$spli2[1],
              year = _datetime$format$spli2[2];

          var _ref = [Number(date), Number(month) - 1, Number(year)];
          date = _ref[0];
          month = _ref[1];
          year = _ref[2];
          ...
          var _datetime$format$spli3 = datetime.format('DD/MM').split('/'),
              _datetime$format$spli4 = _slicedToArray(_datetime$format$spli3, 2),
              _date = _datetime$format$spli4[0],
              _month = _datetime$format$spli4[1];

          var _ref2 = [Number(_date), Number(_month) - 1];
          _date = _ref2[0];
          _month = _ref2[1];
          datetime = this.state.datetime.clone().set({
            date: _date,
          ...
          var _datetime$format$spli5 = datetime.format('HH:mm').split(':'),
              _datetime$format$spli6 = _slicedToArray(_datetime$format$spli5, 2),
              hour = _datetime$format$spli6[0],
              minute = _datetime$format$spli6[1];
