    ...
    value: function onChangeInput(e) {
      ...
      if (datetime.isValid()) {
        ...
        if (this.props.format === 'DD/MM') {
          var _datetime$format$spli = datetime.format('DD/MM').split('/'),
              _datetime$format$spli2 = _slicedToArray(_datetime$format$spli, 2),
              date = _datetime$format$spli2[0],
              month = _datetime$format$spli2[1];

          var _ref = [Number(date), Number(month) - 1];
          date = _ref[0];
          month = _ref[1];
          ...
          var _datetime$format$spli3 = datetime.format('HH:mm').split(':'),
              _datetime$format$spli4 = _slicedToArray(_datetime$format$spli3, 2),
              hour = _datetime$format$spli4[0],
              minute = _datetime$format$spli4[1];
